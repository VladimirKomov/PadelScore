...
| Центральный статус | В Americano одной строкой показывает режим, раунд и остаток, например `AMERICANO 32 · R1 · 10 LEFT`; в остальных режимах — сеты/геймы или цель |
