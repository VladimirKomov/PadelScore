...
2. Прокрутите главный экран и выберите режим игры. Самые частые режимы
...
- `START MATCH` — создать новый матч с выбранными параметрами.

Списки режимов, настроек и значений прокручиваются вертикальным движением
пальца и продолжают движение по инерции. Цветная круглая иконка слева помогает
быстрее найти нужный пункт.
